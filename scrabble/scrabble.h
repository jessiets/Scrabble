...
#include "computer_player.h"    //hw5: computer player 
...
private:
    ...
    size_t num_player;  ///added member to keep track of number of players
    size_t num_human_player;    //keep track of number of human players
