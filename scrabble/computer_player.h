...
public:
    ...
    */
   ComputerPlayer(const std::string& name, size_t hand_size) : Player(name, hand_size) {}; // <--- FIX THIS LINE
...
private:
    ...
    */
    ...
    /* 
    Given a square (not necessarily an anchor square) and a prefix finds 
    all legal ways to extend the word to make valid words.
